...
<?php endif; ?>
    <div class="main-content position-relative bg-gray-100 max-height-vh-100 h-100">
        <!-- Navbar -->
        <?php if (isset($component)) { $__componentOriginal71c6471fa76ce19017edc287b6f4508c = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.navbars.navs.auth','data' => ['titlePage' => 'Perbarui Kriteria','pageRef' => $page_ref]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['titlePage' => 'Perbarui Kriteria','page_ref' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($page_ref)]); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal71c6471fa76ce19017edc287b6f4508c)): ?>
<?php $component = $__componentOriginal71c6471fa76ce19017edc287b6f4508c; ?>
<?php unset($__componentOriginal71c6471fa76ce19017edc287b6f4508c); ?>
<?php endif; ?>
        ...
        <div class="container-fluid px-2 px-md-4">
            ...
            <div class="card card-body mx-3 mx-md-4 mt-6">
                <h6>Data Kriteria</h6>
                <form method='POST' action='<?php echo e(route('edit-kriteria',['id_kriteria' => $kriteria->id], false)); ?>' enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            <div class="mb-3 col-md-4">
                                <label class="form-label">Nama Kriteria</label>
                                <input type="text" name="nama" class="form-control border border-2 p-2"   value="<?php echo e(old('nama') ?? $kriteria->nama); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-3 col-md-4">
                                ...
                                <input type="text" name="kode" class="form-control border border-2 p-2" value="<?php echo e(old('kode') ?? $kriteria->kode); ?>">
                            ...
                            <div class="mb-3 col-md-4">
                                ...
                                <select class="form-control border border-2 p-2" name="tipe_bobot" id="tipe-bobot" >
                                    <?php $__currentLoopData = $list_tipe_bobot; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bobot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($bobot->tipe); ?>" <?php if($bobot->tipe == $kriteria->tipe_bobot): echo 'selected'; endif; ?> ><?php echo e($bobot->tipe); ?></option>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3 col-12">
                                ...
                                <?php $__currentLoopData = $list_bobot; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bobot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($bobot->nilai); ?>" <?php if($bobot->nilai == $bobot_kriteria[$prodi_index]->nilai): echo 'selected'; endif; ?>><?php echo e($bobot->keterangan); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                                <?php $__errorArgs = ['bobot'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row">
                            <div class="mb-3 col-12">
                                ...
                                <textarea class="form-control border border-2 p-2" name="pertanyaan" rows="5" placeholder="Tulis pertanyaan ...." spellcheck="false" required><?php echo e(old('pertanyaan') ?? $kriteria->pertanyaan); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-3 col-12">
                                ...
                                <select class="form-control border border-2 p-2" name="tipe_bobot_pertanyaan" id="tipe_bobot_pertanyaan">
                                    <?php $__currentLoopData = $list_tipe_bobot; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bobot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($bobot->tipe); ?>" <?php if($bobot->tipe == $kriteria->tipe_bobot_pertanyaan): echo 'selected'; endif; ?>><?php echo e($bobot->tipe); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                                <?php $__errorArgs = ['bobot'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
...
<?php unset($__componentOriginal71c6471fa76ce19017edc287b6f4508c); ?>
<?php endif; ?>
<?php /**PATH E:\@BISMILLAH WISUDAH\spk-jimmy\resources\views/pages/kriteria/edit.blade.php ENDPATH**/ ?>