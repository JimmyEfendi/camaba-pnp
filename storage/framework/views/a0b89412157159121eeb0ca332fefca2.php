...
<?php endif; ?>
        ...
        <div class="container-fluid px-2 px-md-4">
            ...
            <div class="card card-body mx-3 mx-md-4 mt-6">
                <form method='POST' action='<?php echo e(route('create-prodi')); ?>' enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            <div class="mb-3 col-12">
                                ...
                                <select class="form-control border border-2 p-2" name="id_jurusan">
                                    ...
                                    <option value="<?php echo e($jurusan->id); ?>"><?php echo e($jurusan->kode); ?> - <?php echo e($jurusan->nama); ?></option>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row">
                            <div class="mb-3 col-12">
                                ...
                                <textarea class="form-control border border-2 p-2" name="deskripsi" id="text-editor"  rows="5" placeholder="Tulis deskripsi tentang program studi" spellcheck="false" ><?php echo e(old('deskripsi')); ?></textarea>
...
<?php unset($__componentOriginal71c6471fa76ce19017edc287b6f4508c); ?>
<?php endif; ?>
<?php /**PATH C:\Users\Asus\Desktop\spk-jimmy\resources\views/pages/prodi/create.blade.php ENDPATH**/ ?>