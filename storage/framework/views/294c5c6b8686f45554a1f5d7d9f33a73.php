...
<?php endif; ?>
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        <!-- Navbar -->
        <?php if (isset($component)) { $__componentOriginal71c6471fa76ce19017edc287b6f4508c = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.navbars.navs.auth','data' => ['titlePage' => 'Prodi','pageRef' => $page_ref]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['titlePage' => 'Prodi','page_ref' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($page_ref)]); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal71c6471fa76ce19017edc287b6f4508c)): ?>
<?php $component = $__componentOriginal71c6471fa76ce19017edc287b6f4508c; ?>
<?php unset($__componentOriginal71c6471fa76ce19017edc287b6f4508c); ?>
                ...
                <div class="col-12">
                    <div class="card my-4">
                        ...
                        <div class=" me-3 my-3 text-end">
                            <a class="btn bg-gradient-dark mb-0" href="<?php echo e(route('create-prodi')); ?>"><i
                                    class="material-icons text-sm">add</i>&nbsp;&nbsp;Tambah Program Studi</a>
                        </div>
                        <?php endif; ?>
                        <div class="card-body px-0 pb-2">
                            <div class="table-responsive p-0">
                            <?php if(isset($list_prodi) && $list_prodi->count() > 0): ?>
                                        ...
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                    <div class="d-flex flex-column justify-content-center">
                                                        <p class="ms-2 text-sm"><?php echo e($prodi->kode); ?></p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div >
                                                        <img src="<?php echo e(asset('assets')); ?>/img/logos/prodi/<?php echo e($prodi->logo); ?>"
                                            ...
                                            <td>
                                                <div class="d-flex flex-column justify-content-center">
                                                    <h6 class="mb-0 text-sm"><?php echo e($prodi->nama); ?></h6>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="d-flex flex-column justify-content-center">
                                                    <h6 class="mb-0 text-sm"><?php echo e($prodi->akreditasi); ?></h6>
                                                </div>
                                            </td>
                                            <td class="align-middle text-center">
                                                <span class="text-secondary text-xs font-weight-bold"><?php echo e($prodi->updated_at->diffForHumans()); ?></span>
                                            </td>
                                            <?php if(auth()->user()->role == "admin"): ?>
                                            <td class="align-middle">
                                                <a rel="tooltip" class="btn btn-success btn-link"
                                                    href="<?php echo e(route('edit-prodi',['id_prodi' => $prodi->id], false)); ?>"
                                                    title="">
                                                    <i class="material-icons">edit</i>
                                                    <div class="ripple-container"></div>
                                                </a>
                                                <a class="btn btn-info btn-link"
                                                    href="<?php echo e(route('show-prodi',['id_prodi' => $prodi->id], false)); ?>"
                                                    target="_blank">
                                                    <i class="material-icons">visibility</i>
                                                    <div class="ripple-container"></div>
                                                </a>
                                                <a rel="tooltip" class="btn btn-danger btn-link"
                                                    href="<?php echo e(route('delete-prodi',['id_prodi' => $prodi->id], false)); ?>"
                                                    title="">
...
<?php unset($__componentOriginal71c6471fa76ce19017edc287b6f4508c); ?>
<?php endif; ?>
<?php /**PATH C:\Users\Asus\Desktop\spk-jimmy\resources\views/pages/prodi/index.blade.php ENDPATH**/ ?>